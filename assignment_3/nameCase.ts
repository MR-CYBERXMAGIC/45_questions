...
let personName : string = "muhamad raza mustafa";
...
function toTitleCase(word: string): string       //function which take string as parameter and returns string
{
  let titleCase:string = "";
  let words : string[]= word.split(' ');       // split(' ') in an in build function that splits the string at each space, creating an array of separate words.
